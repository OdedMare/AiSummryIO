...
| `follow_up` | A message in an existing conversation | Reuses prior evidence; runs **one** active, authorized workflow or one FDE-approved tool, or answers from cache |
