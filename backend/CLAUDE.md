...
Follow-ups reuse conversation evidence and run one relevant active workflow or
one FDE-approved standalone tool when needed. An explicit action request that
names an authorized workflow runs it directly.
